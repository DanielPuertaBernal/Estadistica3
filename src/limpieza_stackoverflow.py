...
# Salidas: el dataset limpio va donde lo fija el protocolo (seccion 1.9); las
# tablas y graficas auxiliares van aparte, en salidas/.
ARCHIVO_LIMPIO = RAIZ / "data" / "stackoverflow_limpio.csv"
